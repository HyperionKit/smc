...
// Metis Sepolia Testnet token addresses
const TOKENS = {
...
// Metis Sepolia Bridge contract address
const BRIDGE_ADDRESS = "0x1AC16E6C537438c82A61A106B876Ef69C7e247d2";
...
async function main() {
  ...
  console.log("Funding Metis Sepolia Bridge contract with account:", deployer.address);
  ...
  const deploymentDir = path.join(__dirname, "..", "..", "dpsmc", "metis_testnet", "bridge");
