...
const BRIDGE_ADDRESS = "0xd6629696A52E914433b0924f1f49d42216708276";
...
async function main() {
  ...
  console.log("Funding Mantle Bridge contract with account:", deployer.address);
  ...
  const deploymentDir = path.join(__dirname, "..", "..", "dpsmc", "mantle", "bridge");
