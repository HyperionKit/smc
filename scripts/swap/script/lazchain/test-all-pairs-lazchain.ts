...
// Contract addresses (Lazchain deployment)
const TOKENS = {
...
const AMM_ADDRESS = "0xE07471cbe06bC3Dd3F74001A2EFBEeA1D60f51f8";
...
async function testAllPairs() {
  console.log("🚀 Starting comprehensive pair testing on Lazchain...\n");
  ...
  // Generate report
  console.log("\n" + "=".repeat(80));
  console.log("📊 LAZCHAIN PAIR TESTING REPORT");
  ...
  // Save report to file
  const reportContent = `# 🧪 Pair Testing Report - Lazchain Network
...
**${successCount === totalCount ? "🎉 CONCLUSION: The DeFi system is fully operational and ready for user interaction!" : "⚠️ CONCLUSION: The DeFi system is partially operational and needs troubleshooting!"}**`;
  ...
  const reportDir = path.join(__dirname, '..', 'report', 'lazchain');
