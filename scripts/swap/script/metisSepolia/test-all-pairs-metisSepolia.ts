...
// Contract addresses (Metis Sepolia deployment)
const TOKENS = {
...
const AMM_ADDRESS = "0x5AC81bC04fc19871E103667ee4b3f0B77b960D7d";
...
async function testAllPairs() {
  console.log("🚀 Starting comprehensive pair testing on Metis Sepolia...\n");
  ...
  // Generate report
  console.log("\n" + "=".repeat(80));
  console.log("📊 METIS SEPOLIA PAIR TESTING REPORT");
  ...
  // Save report to file
  const reportContent = `# 🧪 Pair Testing Report - Metis Sepolia Network
...
**${successCount === totalCount ? "🎉 CONCLUSION: The DeFi system is fully operational and ready for user interaction!" : "⚠️ CONCLUSION: The DeFi system is partially operational and needs troubleshooting!"}**`;
  ...
  const reportDir = path.join(__dirname, '..', 'report', 'metisSepolia');
